/* ============================================================
   SENTINELA — Conjunto de ícones (minimalista, stroke 2px)
   Uso:  <span data-icon="leaf"></span>  -> hidratado por hydrateIcons()
   ============================================================ */
const ICONS = {
  ...
  alarm:     '<circle cx="12" cy="13" r="8"/><path d="M12 9v4l2 2"/><path d="M5 3 2 6"/><path d="m22 6-3-3"/><path d="m6 19-2 2"/><path d="m18 19 2 2"/>',
  ...
  offline:   '<path d="M12 20h.01"/><path d="M8.5 16.4a5 5 0 0 1 7 0"/><path d="M5 12.9a10 10 0 0 1 5.2-2.7"/><path d="M19 12.9a10 10 0 0 0-3.5-2.4"/><path d="M2 8.8a16 16 0 0 1 8.5-3.8"/><line x1="2" x2="22" y1="2" y2="22"/>',
...
function svgIcon(name, size) {
  ...
  const s = size || 24;
  return `<svg viewBox="0 0 24 24" width="${s}" height="${s}" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${body}</svg>`;
}
...
function hydrateIcons(root) {
  (root || document).querySelectorAll('[data-icon]').forEach(el => {
    ...
    el.innerHTML = svgIcon(name, size ? +size : undefined);
    el.dataset.done = '1';
  });
}
